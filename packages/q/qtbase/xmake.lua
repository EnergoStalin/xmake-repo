package("qtbase")
  ...
  on_install(function(package)
    ...
    os.vrunv("aqt", { "install-qt", "-O", installdir, host, target, versionstr, arch }, { envs = package:configs()['envs'] })
    ...
    if package:is_cross() then
      ...
      os.vrunv("aqt", { "install-qt", "-O", path.join(installdir, "bin_host"), runhost, "desktop", versionstr, hostarch }, { envs = package:configs()['envs'] })
